...
export const itemDatabase = {
  ...
  scarletRunecLoak: {
    ...
    hpBonus: 120,
    mpBonus: 130,
    description: "A cloak inscribed with powerful runes, enhancing fire-based spells and providing strong protection."
  },
  cloudweaversMantle: {
  ...
  obsidianGlyphcloak: {
    ...
    hpBonus: 140,
    mpBonus: 150,
    description: "A cloak adorned with obsidian glyphs, providing excellent protection and boosting dark magic."
  },
  guardiansSkyshroud: {
    ...
    hpBonus: 180,
    mpBonus: 160,
    description: "A shroud worn by the guardians of the sky, offering unparalleled protection and enhancing wind-based magic."
  },
  sunflareRobe: {
    name: "Sunflare Robe",
    type: ITEM_TYPES.ARMOR,
    ...
    hpBonus: 200,
    mpBonus: 250,
    description: "A robe that radiates with the power of the sun, granting immense magical abilities and protection."
  },
