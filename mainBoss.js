...
import { addItemToInventory, checkSpaceInInventory, createItem, getRarityColor } from "./inventory.js";
...
export const MAIN_BOSS_TYPES = [
    {
        ...
        attackSpeed: 0.5,
        attackSize: 0.5,
        dropItems: [{ item: itemDatabase.scarletRunecloak, chance: 0.2 }, { item: itemDatabase.powerLapisia, chance: 0.3 }, { item: itemDatabase.greaterHealthPotion, chance: 1 }]
    },
];
