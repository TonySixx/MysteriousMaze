...
import { createBossCastEffect } from "./utils.js";
...
export class MainBoss extends Boss {
  ...
  createAttackEffect() {
    if (this.model) {
      ...
      const castEffectLeftHand = createBossCastEffect(
        effectPosition,
        this.type.attackColor,
        {
          ...
          offset: { x: -1.5, y: 0.8, z: 0.05 }, // Upravte tyto hodnoty podle potřeby
          speedFactor: 2.0,
          glowIntensity: 2.0,
          minSize: 0.1,
          maxSize: 0.12,
      ...
      scene.add(castEffectLeftHand);

      // Přidáme efekt do seznamu pro aktualizaci a odstranění
      this.activeEffects.push(castEffectLeftHand);
